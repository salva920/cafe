      ...
      <Container maxW="container.xl" py={6}>
        <VStack align="stretch" spacing={6}>
          ...
          <Text color="gray.600" fontSize="sm">
            Registra abonos o liquida la deuda completa. Las ventas a crédito suman aquí automáticamente.
          </Text>

          <Box bg="white" p={5} borderRadius="xl" shadow="sm" borderWidth="1px" borderColor="gray.100" overflowX="auto">
            {customers.length === 0 ? (
        ...
        <ModalContent borderRadius="xl">
          ...
          <ModalBody pb={6}>
            <Text fontSize="sm" color="gray.600" mb={3}>
              Deuda actual: <strong>{abonoCliente ? formatCurrency(abonoCliente.balance) : '—'}</strong>
            </Text>
            <FormControl mb={4}>
