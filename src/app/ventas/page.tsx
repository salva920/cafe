      ...
      <Container maxW="container.xl" py={6}>
        <VStack align="stretch" spacing={6}>
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6}>
            <Box bg="white" p={5} borderRadius="2xl" shadow="montilla" borderWidth="1px" borderColor="blackAlpha.100">
                ...
                <VStack align="stretch" spacing={2} maxH="400px" overflowY="auto">
                  {products
                    ...
                    .map((p: { id: string; name: string; price: number; stock: number }) => (
                      <HStack key={p.id} justify="space-between" p={2} bg="brand.50" borderRadius="lg">
                        <Box flex={1}>
